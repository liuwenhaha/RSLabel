...
define(['./when-76089d4c', './Check-5cd4f88e', './Math-4da9b357', './Cartesian2-88a9081c', './defineProperties-7057a760', './Transforms-30697ad4', './RuntimeError-bd79d86c', './WebGLConstants-e4e9c6cc', './AttributeCompression-3a5fff57', './IndexDatatype-7c4ae249', './IntersectionTests-654d9c0a', './Plane-b1ef5cca', './createTaskProcessorWorker', './EllipsoidTangentPlane-e9c7ad83', './OrientedBoundingBox-58c2eee9', './Color-cde5238c'], function (when, Check, _Math, Cartesian2, defineProperties, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
